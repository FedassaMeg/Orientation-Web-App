...
urlpatterns = [
     ...
     path('api/tfuseranswers/',
          TFUserAnswerViewSet.as_view({'post': 'create'})),
     path('api/scores/<int:pk>/mcuseranswers/',
          MCUserAnswerViewSet.as_view({'get': 'list'})),
     path('api/mcuseranswers/',
          MCUserAnswerViewSet.as_view({'post': 'create'})),
     path('api/scores/<int:pk>/sauseranswers/',
          SAUserAnswerViewSet.as_view({'get': 'list'})),
     path('api/sauseranswers/',
          SAUserAnswerViewSet.as_view({'post': 'create'})),
     path('api/roles/',
