        ...
        <Card>
          <div css={content}>
            ...
            <ol css={unordered}>
              ...
              <li>
                Wash your hands. Use betadine or similar cleansing product
                (unless instructed otherwise) to clean the urethral opening.
              </li>
              <li>
              ...
              <li>
                You will meet resistance when you reach the level of the
                external sphincter. Try to relax by deep breathing, and continue
              ...
              <li>
                ...
                you inflate the balloon. Some men have developed urethral
                injuries due to the balloon being inflated in the urethra. Care
                must be taken to ensure the catheter is in the bladder. You may
                try to irrigate the catheter with a few ounces of sterile water.
                If the solution does not easily return, you may not have the
                catheter far enough in the bladder.
              </li>
            ...
            <ol css={unordered}>
              ...
              <li>Begin to gently insert and advance the catheter.</li>
              <li>
                Once the urine flow starts, advance the catheter another 2
                inches. Hold the catheter in place while you inflate the
                balloon. Care must be taken to ensure the catheter is in the
                bladder. If pain is felt which inflating the balloon, stop;
                deflate the balloon; advance the catheter another 2 inches; and
            ...
            <p>
              ...
              recommend using antimicrobial ointments around the catheter as
              they have not been shown to actually reduce infections. You should
              ...
              bladder. The drainage device should be emptied at least every
              eight hours, or when the device is full. Care must be taken to
              keep the outlet valve from becoming infected. Wash your hands
              before and after handling the drainage device. Do not allow the
              outlet valve to touch anything. If the outlet becomes obviously
              dirty, it should be cleaned with soap and water.
            </p>
            ...
            <p>
              ...
              any more fluid. Slowly pull the catheter out until it is
              completely removed. Some health care providers instruct their
              patients to cut the inflation port tubing before it reaches the
              main tubing of the catheter. After all the water has drained out,
              slowly pull out the catheter until it is completely removed. Be
              careful not to cut the catheter anywhere else. Instruct the
              patient / family PCG to contact their health care provider if: If
              they are unable to remove the catheter with only slight pulling,
              if they are unable to urinate within 8 hours after catheter
              removal, or if their abdomen becomes distended and painful.
            </p>
          </div>
        </Card>
      </div>
